...
public partial class STOKLAR
{
    ...
    public string sto_kod { get; set; } = null!;
    ...
    public bool? sto_CRM_sistemine_aktar_fl { get; set; }
    ...
    public bool? sto_oto_parti_lot_kod_fl { get; set; }
    ...
    public bool? sto_utssisteminegonderilsin_fl { get; set; }

    public bool? sto_posetbeyannamekonusu_fl { get; set; }

    public short? sto_STT_oncesi_kaldirma { get; set; }

    public short? sto_toplam_rafomru { get; set; }

    public bool? sto_fiyat_kasada_belirlenir_fl { get; set; }
    ...
    public bool? sto_cabuk_bozulabilen_urun_fl { get; set; }

    public byte? sto_satin_alma_talep_birim { get; set; }

    public byte? sto_urun_niteligi { get; set; }

    public string? sto_kuresel_urun_numarasi { get; set; }

    public int? sto_yerlilikorani { get; set; }

    public string? sto_karsi_program_kodu { get; set; }

    public bool? sto_lotnoyapartikodugonder_fl { get; set; }
}
