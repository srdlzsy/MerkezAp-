...
namespace FurpaMerkezApi.WebApi.Controllers.Modules.KasaIslemleri.EtiketBelgeleri;

[ApiController]
[Route("api/kasa-islemleri/etiket-belgeleri")]
    ...
    : ModuleMenuControllerBase(ModuleCode, ModuleName, MenuCode, MenuName)
{
    ...
    private const string ListPolicy = "kasa-islemleri.etiket-belgeleri.list";
    private const string DetailPolicy = "kasa-islemleri.etiket-belgeleri.detail";
    private const string CreatePolicy = "kasa-islemleri.etiket-belgeleri.create";
    private const string UpdatePolicy = "kasa-islemleri.etiket-belgeleri.update";
    ...
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status400BadRequest)]
    public Task<ActionResult<IReadOnlyCollection<LabelTagDto>>> Tags(
