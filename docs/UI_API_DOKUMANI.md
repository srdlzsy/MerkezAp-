...
- UI bu dosyayi "Excel'e aktar" butonuyla yeni sekmede veya direkt indirerek sunabilir.
...
- icmal karsilastirma Excel butonu `icmal-karsilastirma/excel` endpointini kullanabilir
